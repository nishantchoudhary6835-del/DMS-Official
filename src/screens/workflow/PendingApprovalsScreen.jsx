    ...
    return (
      <View style={styles.centred}>
        ...
        <Text style={styles.emptyBody}>
          Documents submitted by your team will appear here when they're
  ...
  return (
    <Screen scrollable={false} padded={false}>
      ...
      <Text style={styles.subtitle}>
        Documents currently waiting on your review, based on your role as
        team lead for the submitter.
      </Text>
      ...
      {isLoading ? (
        <Loader message="Loading pending approvals…" />
      ) : (
        <FlatList
          data={workflows}
